...
let selected = false;
let selId = 0;
//Onclick function para resaltar monto seleccionado
function setValue(element) {
  ...
  if (!selected) {
    ...
    selId.style.background = "#cececc"; //fondo dsp de seleccionar
    val.style.background = "#82d14b";
    selId = val;
  }
}
...
function validate() {
  ...
  if (allAreValid) {
    ...
    donation.innerHTML = "";
    donation.innerHTML = "$" + donations + " recaudado en las últimas 24 horas";
  } else {
    if (!cc) {
